...
public abstract class Obstacle {
    ...
    public void setFireBitmap(Bitmap fireBitmap) {
    ...
    public Bitmap getDefault2Bitmap() {
        return default2Bitmap;
    }

    public void setDefault2Bitmap(Bitmap default2Bitmap) {
        this.default2Bitmap = default2Bitmap;
    }
